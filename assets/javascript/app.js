$(document).ready(function() {
    ...
    function reset() {
        trivia = [
            ...
            ["Which of these relatively small countries holds one of the largest Carnival celebrations in the world?", ["Jamaica", "Trinidad and Tobago", "Grenada", "Barbados"], "Trinidad and Tobago"],
            ...
            ["Which of the following is not a traditional part of Mardi Gras in New Orleans?", ["beads", "king cake", "parade floats", "pie eating contests"], "pie eating contests"], 
            ...
            ["Which of the following has not exerted a major cultural influence on the history of Mardi Gras?", ["Hollywood", "French culture", "paganism", "the Catholic Church"], "Hollywood"],
            ["The precise date of Mardi Gras, which varies from year to year, is determined by _____.", ["lottery", "astrology", "Easter", "the Pope"], "Easter"],
